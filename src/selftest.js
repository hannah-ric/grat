...
(function () {
  ...
  async function run() {
    ...
    /* ============ 2026 hardening: coherence, budget, persistence ============ */
    {
      ...
      test('hardening', 'system prompt under the 2620-token ceiling', tk <= 2620 && tk > 800, tk + ' tokens', '≤ 2620'); // raised for the A5 exclusion line, the C1 bed anchors, the G7 e-budget clause, the G6 ask-policy + G10 floor-boundary lines, the M-22 budget digest, X-07's stretcher and door/hinge keys, then the seating-class keys + refusal doctrine (2026-07)
