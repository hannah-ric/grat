...
(function () {
  ...
  const PATHS = {
    ...
    warn: 'M10 3.4 17.4 16.2 H2.6 Z M10 8.4 v3.6 M10 14.3 v0.01',
    stop: 'M6.9 3 h6.2 L17 6.9 v6.2 L13.1 17 H6.9 L3 13.1 V6.9 Z M10 6.6 v4.2 M10 13.6 v0.01',
    check: 'M4 10.6 8.2 14.8 16 5.6',
    user: 'M10 9.6 a3.1 3.1 0 1 0 0 -6.2 a3.1 3.1 0 0 0 0 6.2 M3.8 17 c0.6 -3.2 3.2 -4.9 6.2 -4.9 s5.6 1.7 6.2 4.9',
    arrow: 'M3.5 10 h12 m0 0 -4 -4 m4 4 -4 4',
    lock: 'M5.5 9 h9 a1.2 1.2 0 0 1 1.2 1.2 v5.1 a1.2 1.2 0 0 1 -1.2 1.2 h-9 a1.2 1.2 0 0 1 -1.2 -1.2 v-5.1 A1.2 1.2 0 0 1 5.5 9 Z M6.8 9 V6.6 a3.2 3.2 0 0 1 6.4 0 V9 M10 12 v1.8'
  };
  const FILLED = {
